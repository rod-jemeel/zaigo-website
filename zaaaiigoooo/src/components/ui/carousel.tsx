    ...
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        {current === index && link && (
          ...
          >
            <h3 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold mb-3 drop-shadow-lg">
              {title}
            </h3>
            <span className="text-green-400 text-base md:text-lg font-semibold flex items-center gap-2 hover:gap-3 transition-all drop-shadow-lg">
              View Case Study
